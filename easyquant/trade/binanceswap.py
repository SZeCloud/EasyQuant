...
import time
from easyquant.exchange.binance import binance_swap
...
class BINANCESWAP:
    ...
    def tickers(self):
        receipt = self.__binance_swap.get_ticker(self.__instrument_id)
        return receipt
    ...
    def info(self):
        result = requests.get("https://fapi.binance.com/fapi/v1/exchangeInfo").json()
        return result